...
void CGameMain::BuildLevel1(){
    ...
    m_pMonster1->setSpeedX(-40.f);
    m_pMonster1->setSpeedY(0.f);
    m_pMonster1->setPosX(580.f);
    m_pMonster1->setPosY(21.f);
    m_pMonster1->init();
    m_vWeapon.push_back(m_pMonster1);
    ...
    m_pMonster1->setSpeedX(-40.f);
    m_pMonster1->setSpeedY(0.f);
    m_pMonster1->setPosX(600.f);
    m_pMonster1->setPosY(11.f);
    m_pMonster1->init();
    m_vWeapon.push_back(m_pMonster1);
